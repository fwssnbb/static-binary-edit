...
if __name__ == '__main__':
    ...
    print os.popen(r'python3 .\idahunt.py --inputdir ..\..\exe_sample\goodware --cleanup --temp-cleanup').read()
    print os.popen(r'python3 .\idahunt.py --inputdir ..\..\exe_sample\malware --cleanup --temp-cleanup').read()


    tmp = os.popen(r'python3 .\idahunt.py --inputdir ..\..\exe_sample\goodware --scripts .\exactOpSequence.py --analyse').read()
    print tmp
    tmp = os.popen(r'python3 .\idahunt.py --inputdir ..\..\exe_sample\malware --scripts .\exactOpSequence.py --analyse').read()
    print tmp
    print os.popen(r'python3 .\idahunt.py --inputdir ..\..\exe_sample\goodware --cleanup --temp-cleanup').read()
    print os.popen(r'python3 .\idahunt.py --inputdir ..\..\exe_sample\malware --cleanup --temp-cleanup').read()
